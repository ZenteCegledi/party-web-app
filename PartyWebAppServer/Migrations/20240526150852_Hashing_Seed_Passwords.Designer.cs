...
namespace PartyWebAppServer.Migrations
{
    ...
    [Migration("20240526150852_Hashing_Seed_Passwords")]
    partial class Hashing_Seed_Passwords
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PartyWebAppServer.Database.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Username = "admin",
                            BirthDate = new DateTime(1994, 5, 26, 15, 8, 51, 730, DateTimeKind.Utc).AddTicks(4821),
                            Email = "admin@admin.com",
                            Name = "Admin User",
                            Password = "$2a$11$Guo8vsOW4mswzm/BOX.iAuHUZCglXCfm2bWgv2pE.0NrzpkVHgc2q",
                            PasswordUpdated = new DateTime(2024, 5, 26, 15, 8, 51, 730, DateTimeKind.Utc).AddTicks(4831),
                            Phone = "1234567890",
                            RoleId = 1
                        },
                        new
                        {
                            Username = "user",
                            BirthDate = new DateTime(2004, 5, 26, 15, 8, 51, 871, DateTimeKind.Utc).AddTicks(6529),
                            Email = "user@gmail.com",
                            Name = "User",
                            Password = "$2a$11$xrdXnppL6d1tjw6v2.1kI.lUwKwr0r1yiMXu8mfE.jbRQdAL0mU3i",
                            PasswordUpdated = new DateTime(2024, 5, 26, 15, 8, 51, 871, DateTimeKind.Utc).AddTicks(6539),
                            Phone = "0987654321",
                            RoleId = 2
                        });
                });
